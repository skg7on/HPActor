...
// Helper: convert HPActor Ipv4Endpoint to protobuf Ipv4Endpoint
static void to_proto(::hpactor::net::Ipv4Endpoint* pb_ep, const ::hpactor::Ipv4Endpoint& ep) {
    pb_ep->set_addr(ep.addr);  // Network byte order
    pb_ep->set_port(ep.port_nw);
}

// Helper: convert HPActor Ipv6Endpoint to protobuf Ipv6Endpoint
static void to_proto(::hpactor::net::Ipv6Endpoint* pb_ep, const ::hpactor::Ipv6Endpoint& ep) {
    pb_ep->set_addr(ep.addr.data(), 16);
    pb_ep->set_port(ep.port_nw);
}

// Helper: convert HPActor CommunicationEndpoint to protobuf Endpoint
static void to_proto(::hpactor::net::Endpoint* pb_endpoint, const ::hpactor::CommunicationEndpoint& ep) {
...
// Helper: convert HPActor ActorAddress to protobuf ActorAddress
static void to_proto(::hpactor::net::ActorAddress* pb_addr, const ::hpactor::ActorAddress& addr) {
...
// Helper: convert protobuf Ipv4Endpoint to HPActor Ipv4Endpoint
static ::hpactor::Ipv4Endpoint from_proto(const ::hpactor::net::Ipv4Endpoint& pb_ep) {
    return ::hpactor::Ipv4Endpoint{pb_ep.addr(), static_cast<uint16_t>(pb_ep.port())};
}

// Helper: convert protobuf Ipv6Endpoint to HPActor Ipv6Endpoint
static ::hpactor::Ipv6Endpoint from_proto(const ::hpactor::net::Ipv6Endpoint& pb_ep) {
...
static ::hpactor::CommunicationEndpoint from_proto(const ::hpactor::net::Endpoint& pb_endpoint) {
...
// Helper: convert protobuf ActorAddress to HPActor ActorAddress
static ::hpactor::ActorAddress from_proto(const ::hpactor::net::ActorAddress& pb_addr) {
