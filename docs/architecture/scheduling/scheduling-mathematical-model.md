...
| :-------- | :-------------- | :---------------- | :----------- |
| MPSC Queue | Linearizability: every execution equivalent to a valid sequential history | Progress: producer enqueue is wait-free; consumer dequeue is lock-free (returns or finds empty) | ABA-freedom argument; LP assignment above |
