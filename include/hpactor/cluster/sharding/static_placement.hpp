...
/// \brief Static TOML-defined shard→node mapping.
class StaticPlacement : public IPlacementStrategy {
  public:
    void set_mapping(ShardId shard, const std::string& node);
  ...
  private:
    std::unordered_map<ShardId, std::string> mapping_;
};
